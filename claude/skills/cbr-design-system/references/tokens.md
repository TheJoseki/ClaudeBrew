...
The token layer of the design system: the three-layer architecture, the core
scales, dark-mode patterns, Tailwind theme wiring, component state specs, and
the token section every SCREEN spec carries.

Deeper per-topic detail lives in the sibling references listed at the end.
...
For the HSL-variable form that shadcn/ui expects, see
`references/tailwind-integration.md` and `references/shadcn-theming.md`.
