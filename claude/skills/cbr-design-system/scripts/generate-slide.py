...
def main():
    ...
    if args.demo:
        ...
        demo_slides = [
            ...
            {
                'type': 'testimonial',
                'quote': 'ClaudeBrew replaced 3 tools and 2 contractors. Our content output tripled while costs dropped 60%.',
                'author': 'Sarah Chen',
        ...
        html = generate_deck(demo_slides, "ClaudeBrew Marketing - Pitch Deck")
